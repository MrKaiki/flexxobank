...
<section id="terms" class="my-5">
        <div class="container">
          <div class="row text-start">
            <h2 class="title"><b>Termos & Condições</b></h2>
            É de total responsabilidade do cliente verificar periodicamente se há alterações nesses termos!</p>
            <ul>
              <li class="say5">
              ...
              <p style="font-weight: 600; color:#fff;">Ao comprar qualquer produto desta loja você está automaticamente concordando com os termos de uso do site! <br><br>Última atualização dos termos: (03/03/2022)</p>                     
              </ul>  
          </div>
        </div>
      </section>    
